...
class DefaultDateAndTimeTextField extends StatefulWidget {
  ...
  const DefaultDateAndTimeTextField({
    Key? key,
    this.icon,
  ...
  @override
  _DefaultDateAndTimeTextFieldState createState() =>
      _DefaultDateAndTimeTextFieldState();
}

class _DefaultDateAndTimeTextFieldState
    extends State<DefaultDateAndTimeTextField>
  ...
  String _formatDateTime(DateTime dateTime) {
    if (widget.mode == DateTimeMode.date) {
      return DateFormat('yyyy-MM-dd').format(dateTime);
    } else if (widget.mode == DateTimeMode.time) {
